...
### Overview
In this assignment, you'll create a burger logger with MySQL, Node, Express, Handlebars and a homemade ORM (yum!). X Be sure to follow the MVC design pattern; use Node and MySQL to query and route data in your app, and Handlebars to X generate your HTML.
...
X 8. Require the following npm packages inside of the server.js file:
   * express
   * body-parser
...
X 5. Now you're going to run these SQL files.
